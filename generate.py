...
def main():
    ...
    # Add arguments
    parser.add_argument(
        "-b", "--benchmark", type=str, required=True, help="Name of benchmark dataset"
    )
    parser.add_argument(
        "-t", "--train_author_key", type=int, required=True, help="Author key in pkl file"
    )
    parser.add_argument("--seed", type=int, default=42, help="Generation seed")
    parser.add_argument(
        "--model-id", default="mistralai/Mistral-7B-Instruct-v0.2", help="Base model used for training"
    )
